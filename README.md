...
| **v0.5.0** 🚧 | Promise constructor + `.then`/`.catch` + chaining + `Promise.resolve`/`reject`/`all`/`race`. Bridge functions, pending-callback state machine, 4-bit GC tag mask. 393 tests. |
