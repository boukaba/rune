...
## P11: JIT opcode coverage is Smi-only (46/61 opcodes) 🟡 In progress

**Symptom:** 46/61 opcodes are JIT-compiled. Still missing: LoadFloat64, LoadStringConst, Call, all object/array/string ops, type conversions.
...
| P11 | JIT coverage (now 46/61 opcodes) | 🟡 In progress | — |
