...
| **5b** | Full function AOT compiler (bytecode→native for all opcodes) | 3d | 🔴 P0 | 🟡 In progress | AArch64 + x86-64 baseline JIT covers 36/61 opcodes (Smi arithmetic, comparison, bitwise, unary, branches, locals, property access). Missing: floats, strings, calls, globals. |
...
| **5l** | Remaining JIT opcodes (floats, property access, calls) | 2d | 🟠 P1 | 🟡 In progress | Added Neg, Not, LoadPropertyIC, UnaryPlus, BitNot, StorePropertyIC, ShrU, Eq, Ne, Swap. JIT now at 36/61. Next: TypeOf, LoadFloat64, lexical ops. |
...
- JIT: 36/61 opcodes covered (all Smi arithmetic/comparison/bitwise/unary/branches).
...
**Gaps (documented):** No standard library, optimizing JIT (remaining 25/61 opcodes), modules, classes, async/await. 5–230× slower than V8 on hot loops. JIT covers 36/61 opcodes.
