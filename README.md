...
| **v0.5.0** 🚧 | Promise: constructor, `.then`/`.catch` chaining, `resolve`/`reject`/`all`/`race`, `.finally`, **microtask queue** with reaction storage. Parser reserved-word fix. test262 Promise 46%. 393 tests. |
