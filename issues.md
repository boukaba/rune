...
## P11: JIT opcode coverage is Smi-only (45/61 opcodes) 🟡 In progress

**Symptom:** 45/61 opcodes are JIT-compiled. Still missing: LoadFloat64, LoadStringConst, Call, all object/array/string ops, type conversions.
...
| P11 | JIT coverage (now 45/61 opcodes) | 🟡 In progress | — |
